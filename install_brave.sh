...
proot-distro login debian --user $varname --shared-tmp -- env DISPLAY=:1.0 wget https://github.com/bengkelgawai/App-Installer/raw/main/brave-browser-release.list
